...
Single responsibility: manage the time series history of the plugin stats.
...
class HistoryMixin:
    """Provide history data management to the plugin model."""

    def _init_history(self, items_history_list=None):
        """Initialize the history attributes."""
        self.items_history_list = items_history_list
        self.stats_history = self.init_stats_history()

    def history_enable(self):
        """Return True if the stats history is enabled."""

...
"""View rendering mixin.

Single responsibility: build and expose the ``views`` structure (the V of the
MVC pattern) and provide the helpers used to render the curses interface.
...
class ViewMixin:
    """Provide stats views and curses rendering helpers to the plugin model."""

    def _init_view(self):
        """Initialize the view rendering attributes."""

...
"""Serialization / export formatting mixin.

Single responsibility: expose the stats object in RAW or JSON format.
...
class SerializationMixin:
    """Provide JSON / export formatting methods to the plugin model."""

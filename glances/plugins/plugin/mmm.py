...
"""MMM (Min/Max/Mean) mixin.

Provide the Min/Max/Mean computation responsibilities of the Glances
plugin model for fields flagged with mmm=True.
"""
...
class MMMMixin:
    """Mixin class to compute Min/Max/Mean on plugin stats fields."""
